        ...
        <Form @submit="login" :validation-schema="userSchema" class="mb-12">
          ...
          <div class="w-full flex justify-center">
            <button @click.prevent="loginWithGoogle"
              class="flex justify-center items-center gap-3 w-[55%] h-[54px] py-3 rounded bg-gray-200 hover:bg-gray-700 hover:text-white focus:outline-none">
          ...
          <div class="text-center text-grey-dark mt-7">
            Chưa có tài khoản?
            <RouterLink class="no-underline border-b border-blue-800 text-blue-800" to="/xac-thuc/dang-ky">
              Đăng ký
            </RouterLink>
          </div>
        </Form>
