<template>
    <div class="flex flex-col p-[20px] border-[0.5px] border-gray-300">
        <div class="pb-5 mb-4 flex items-center gap-3 border-b-[0.5px] border-gray-300">
        ...
        <div class="w-full">
            <div class="bg-gray-300 px-[5px] py-[20px] border-[0.5px] border-gray-300">
            ...
            <div class="border-[0.5px] border-t-0 border-gray-300">
                <!-- loop here -->
                <OrderProductItem :item="item" v-for="(item, index) in cartStore.items" :key="index" />
            </div>
        </div>
    </div>
</template>
